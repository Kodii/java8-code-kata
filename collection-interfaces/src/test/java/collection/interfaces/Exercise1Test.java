...
public class Exercise1Test extends ClassicOnlineStore {
	...
	public void iterateByForEach() {
		...
		/**
		 * Create a {@link Consumer} which represents an operation to add customer's
		 * name to {@link nameList} list. Iterate {@link customerIterable} with
		 * {@link Iterable#forEach} and use the {@link Consumer} to finish creating the
		 * name list.
		 */
	...
	public void whoHaveNoEInYourName() {
		 ...
		 * Remove elements from {@link nameCollection} which contains "e" using
		 * {@link Collection#removeIf}.
		 */
	...
	public void replaceTheElements() {
		 ...
		 * Replace the elements in {@link nameList} with string wrapped with "()" using
		 * {@link List#replaceAll} .
		 */
	...
	public void sortByName() {
		...
		/**
		 * Create a {@link Comparator} to sort the name list by their name's length in
		 * ascending order.
		 */
	...
	public void createStream() {
		...
		/**
		 * Create a serial {@link Stream} using {@link Collection#stream} You can learn
		 * about {@link Stream} APIs at stream-api module.
		 */
	...
	public void createParallelStream() {
		...
		/**
		 * Create a parallel {@link Stream} using {@link Collection#parallelStream} or

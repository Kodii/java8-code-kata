...
public class Exercise3Test {
	...
	public void localDateTimeOf() {
		/**
		 * Create a {@link LocalDateTime} of 2015-06-20 23:07:30 by using
		 * {@link LocalDateTime#of}
		 */
		LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(2015, 06, 20), LocalTime.of(23, 07, 30));
	...
	public void localTimeWith() {
		...
		/**
		 * Create a {@link LocalDateTime} from {@link ldt} with first day of the next
		 * month and also truncated to hours.
		 */
		LocalDateTime localDateTime = ldt.withMonth(7)
			.withDayOfMonth(1)
	...
	public void localDatePlusMinus() {
		...
		/**
		 * Create a {@link LocalDateTime} from {@link ldt} with 10 month later and 5
		 * hours before by using {@link LocalDateTime#plus*} or
		 * {@link LocalDateTime#minus*}
		 */
		LocalDateTime localDateTime = ldt.plusMonths(10)
			.minusHours(5);
	...
	public void localDateTimeFormat() {
		...
		/**
		 * Format {@link ldt} to a {@link String} as "2015_06_18_23_07_30" by using
		 * {@link LocalDateTime#format} and {@link DateTimeFormatter#ofPattern}
		 */
	...
	public void toLocalDateAndTime() {
		...
		/**
		 * Create a {@link LocalDate} and a {@link LocalTime} from {@link ldt} by using
		 * {@link LocalDateTime#toLocalDate} and {@link LocalDateTime#toLocalTime}
		 */
	...
	public void toLocalDateTime() {
		...
		/**
		 * Create two equal {@link LocalDateTime} from {@link ld} and {@link lt} by
		 * using {@link LocalDate#atTime} and {@link LocalTime#atDate}
		 */

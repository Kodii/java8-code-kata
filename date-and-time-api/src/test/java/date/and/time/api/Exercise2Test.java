...
public class Exercise2Test {
	...
	public void localTimeOfHourToNanoSec() {
		 ...
		 */
		LocalTime localTime = LocalTime.of(23, 07, 03, 100000000);
	...
	public void localTimeParse() {
		/**
		 * Create a {@link LocalTime} of 23:07:03.1 from String by using
		 * {@link LocalTime#parse}
		 */
	...
	public void localTimeWith() {
		...
		/**
		 * Create a {@link LocalTime} from {@link lt} with hour 21 by using
		 * {@link LocalTime#withHour} or {@link LocalTime#with}
		 */
	...
	public void localTimePlus() {
		...
		/**
		 * Create a {@link LocalTime} from {@link lt} with 30 minutes later by using
		 * {@link LocalTime#plusMinutes} or {@link LocalTime#plus}
		 */
	...
	public void localTimeMinus() {
		...
		/**
		 * Create a {@link LocalTime} from {@link lt} with 3 hours before by using
		 * {@link LocalTime#minusHours} or {@link LocalTime#minus}
		 */
	...
	public void localTimeMinusDuration() {
		...
		/**
		 * Define a {@link Duration} of 3 hours 30 minutes and 20.2 seconds Create a
		 * {@link LocalTime} subtracting the duration from {@link lt} by using
		 * {@link LocalTime#minus}
		 */
	...
	public void localDateIsBefore() {
		...
		/**
		 * Check whether {@link lt2} is before {@link lt} or not by using
		 * {@link LocalTime#isAfter} or {@link LocalTime#isBefore}
		 */
	...
	public void localTimeTruncatedTo() {
		...
		/**
		 * Create a {@link LocalTime} from {@link lt} truncated to minutes by using
		 * {@link LocalTime#truncatedTo}
		 */
		LocalTime localTime = lt.truncatedTo(MINUTES);
